...
# !!!
            self.freqs = 1. / (10000**(torch.arange(0, frequency_embedding_size, 2, dtype=torch.float32) / frequency_embedding_size)).to('cuda')
            # self.freqs = nn.Buffer(
                # 1.0 / (10000**(torch.arange(0, frequency_embedding_size, 2, dtype=torch.float32) / frequency_embedding_size)),
                # persistent=False)
