...
# !!!
        vae_state_dict = {k: vae_state_dict[k] for k in vae_state_dict.keys() if k not in ['data_mean', 'data_std']}
        ...
        if mode == '16k':
            ...
            self.vocoder = BigVGANv2.from_pretrained('nvidia/bigvgan_v2_44khz_128band_512x', use_cuda_kernel=False)
